...
export default function ChatBot() {
  ...
  const history = ['How to do Javascript', 'How to do Python', 'How to do this', 'How to do that'];
  ...
  const handleSubmit = () => {
    ...
    const answer = qAndA[question] || "Sorry, I don't have an answer for that question.";
